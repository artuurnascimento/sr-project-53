...
const Auth = () => {
  ...
  // Redirect authenticated users to dashboard selector
  if (user) {
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input id="login-email" type="email" placeholder="seu@email.com" className="h-11 border-slate-300 focus:border-primary" value={loginForm.email} onChange={e => setLoginForm({
              ...loginForm,
            ...
            <div className="space-y-2">
              ...
              <Input id="login-password" type="password" placeholder="••••••••" className="h-11 border-slate-300 focus:border-primary" value={loginForm.password} onChange={e => setLoginForm({
              ...loginForm,
