          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="flex flex-col">
                ...
                <p className="text-xs text-slate-500 mt-0.5">Portal</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col w-full bg-white/60 backdrop-blur-xl border-r border-slate-200/60 shadow-xl">
            ...
            <div className="p-8 border-b border-slate-200/60">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-medium">Portal do Colaborador</p>
                </div>
              </div>
            </div>
            ...
            <nav className="flex-1 p-6">
              ...
              <div className="mt-8 p-4 rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/10">
                <h3 className="text-sm font-semibold text-slate-700 mb-3">Hoje</h3>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">Entrada</span>
                    <span className="text-sm font-medium text-slate-700">08:00</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-slate-500">Horas trabalhadas</span>
                    <span className="text-sm font-medium text-primary">6h 30m</span>
                  </div>
                </div>
              </div>
            </nav>
